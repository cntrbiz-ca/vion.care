    ...
    <html lang="ru">
      ...
      <body>
        ...
        <Script id="ym" strategy="afterInteractive">{`
          ...
          })(window, document, "script", "https://mc.yandex.ru/metrika/tag.js?id=108576039", "ym");
          ym(108576039, "init", {
        ...
        <noscript>
          <div>
            <img src="https://mc.yandex.ru/watch/108576039" style={{position:'absolute',left:'-9999px'}} alt="" />
          </div>
        </noscript>
      </body>
    </html>
